...
urlpatterns = ('',
    ...
    url(r'^stats/compare/$',
        'statsonice.stats.compare', name='compare'),
    url(r'^stats/compare/'+skater_url('skater1')+r'/'+skater_url('skater2')+r'/'+skater_url('skater3')+r'/'+skater_url('skater4')+r'/'+skater_url('skater5')+r'/'+skater_url('skater6')+r'/$',
        'statsonice.stats.compare_result', name='compare_result'),
    url(r'^stats/custom/$',
