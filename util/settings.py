# Production Django settings for statsonice project.

import os
import django
try:
    from util.keys.secret_key import *
except ImportError:
    DB_NAME = 'ASDFASDFASDF'
    DB_USER = 'ASDFASDFASDF'
...
SERVER_EMAIL='statsonice-bot@statsonice.com'
DJANGO_ROOT = os.path.dirname(os.path.realpath(django.__file__))
SITE_ROOT = os.path.dirname(os.path.realpath(__file__))+'/../statsonice/'
...
FIXTURE_DIRS = (
    os.path.join(SITE_ROOT, 'statsonice/models/assets')
)
